...
const EditPostForm: React.FC<EditPostFormProps> = ({ post, onSuccess, onCancel }) => {
  ...
  // Effect to update form data if the 'post' prop changes (e.g., if you edit a different post)
  useEffect(() => {
    setFormData({
      title: post.title,
      content: post.content,
    ...
    setCurrentStep(1); // Reset to first step when editing a new post
  }, [post]);
  ...
  const nextStep = () => {
    // Add validation specific to each step if needed
          ...
          <div style={{ animation: 'slideInRight 0.5s ease-out' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{
                  color: 'var(--midnight-blue)', /* Made darker */
                  fontFamily: "'Rajdhani', sans-serif",
                  fontSize: '1rem',
                  fontWeight: '600',
                  textShadow: '0 0 5px rgba(0, 255, 255, 0.3)' /* Pale cyan glow */
                }}>
                  ✨ POST TITLE
                </span>
              </div>
              ...
              <div style={{
                ...
                <span style={{
                  color: formData.title.length > 180 ? '#ff4444' : 'var(--midnight-blue)', /* Made darker */
                  fontSize: '0.9rem',
            ...
            <div style={{
              ...
              <div style={{
                ...
                <input
                  ...
                  placeholder=" " /* Placeholder is important for floating label */
                  style={{
                    width: '100%',
                ...
                <label style={{
                  position: 'absolute',
                  left: '4rem',
                  top: formData.author ? '0.5rem' : '50%', /* Adjust top based on content */
                  transform: formData.author ? 'translateY(0)' : 'translateY(-50%)', /* Adjust transform */
                  color: 'var(--midnight-blue)', /* Made darker */
                  fontFamily: "'Rajdhani', sans-serif",
                  fontSize: formData.author ? '0.9rem' : '1.1rem', /* Adjust font size */
                  fontWeight: '500',
                  transition: 'all 0.3s ease',
                  pointerEvents: 'none'
                }}>
          ...
          <div style={{ animation: 'slideInRight 0.5s ease-out' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{
                  color: formData.summary.length > 450 ? '#ff4444' : 'var(--midnight-blue)', /* Made darker */
                  fontSize: '0.9rem',
                  fontFamily: "'JetBrains Mono', monospace",
                  marginLeft: 'auto'
                }}>
          ...
          <div style={{ animation: 'slideInRight 0.5s ease-out' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{
                  color: formData.content.length > 9000 ? '#ff4444' : 'var(--midnight-blue)', /* Made darker */
                  fontSize: '0.9rem',
                  fontFamily: "'JetBrains Mono', monospace",
                  marginLeft: 'auto'
                }}>
      ...
      <div className="premium-card" style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            fontSize: '2.5rem',
            fontWeight: '900',
            textShadow: '0 0 25px rgba(0, 255, 255, 0.5), 0 0 40px rgba(0, 255, 255, 0.3)', /* Pale cyan glow */
            marginBottom: '1rem'
          }}>
            ✨ CREATE NEW POST ✨
          </h2>
...
export default EditPostForm; // <--- CORRECTED THIS LINE
